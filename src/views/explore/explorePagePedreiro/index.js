        ...
        <div id="GroupInformation">
            <header>
                <div id="link">
                    ...
                    <p id="service">Serviços de Pedreiros</p>
                </div>
                <p id="title">Serviços de Pedreiros</p>
                <p id="description">Aqui você pode encontrar os melhores pedreiros.</p>
                <div id="order-by">
...
export default ExplorePagePedreiro
